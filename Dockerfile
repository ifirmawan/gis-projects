...
RUN mkdir -p /usr/src/gisjourney
...
COPY src /usr/src/gisjourney/
WORKDIR /usr/src/gisjourney
...
RUN chmod +x /usr/src/gisjourney/tasks.py \
    && chmod +x /usr/src/gisjourney/entrypoint.sh
...
# ENTRYPOINT /usr/src/gisjourney/entrypoint.sh
